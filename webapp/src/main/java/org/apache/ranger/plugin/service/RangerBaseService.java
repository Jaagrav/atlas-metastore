...
public abstract class RangerBaseService {
	...
	private Map<String, RangerPolicyResource> getResourcesForPrefix(String resourcePropertyPrefix) {
		Map<String, RangerPolicyResource> policyResourceMap = new HashMap<String, RangerPolicyResource>();
	...
	private void addCustomRangerDefaultPolicies(List<RangerPolicy> ret, Map<String, RangerPolicyResource> policyResourceMap, String policyPropertyPrefix) throws Exception {
	...
	private RangerPolicy getDefaultPolicy(List<RangerServiceDef.RangerResourceDef> resourceHierarchy) throws Exception {
		...
		RangerPolicyItem policyItem = createDefaultPolicyItem(policy.getResources());
	...
	private RangerPolicyItem createDefaultPolicyItem(Map<String, RangerPolicyResource> policyResources) throws Exception {
		...
		List<RangerPolicyItemAccess> accesses = getAllowedAccesses(policyResources);
	...
	protected List<RangerPolicyItemAccess> getAllowedAccesses(Map<String, RangerPolicyResource> policyResources) {
		List<RangerPolicyItemAccess> ret = new ArrayList<RangerPolicyItemAccess>();
	...
	protected Map<String, RangerPolicyResource> createDefaultPolicyResource(List<RangerServiceDef.RangerResourceDef> resourceHierarchy) throws Exception {
		if (LOG.isDebugEnabled()) {
