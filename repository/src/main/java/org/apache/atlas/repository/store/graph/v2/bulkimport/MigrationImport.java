...
public class MigrationImport extends ImportStrategy {
    ...
    private AtlasEntityStoreV2 createEntityStore(AtlasGraph graph, AtlasTypeRegistry typeRegistry) {
        ...
        EntityGraphMapper entityGraphMapper = new EntityGraphMapper(deleteDelegate, restoreHandlerV1, typeRegistry, graph, relationshipStore, entityChangeNotifier, getInstanceConverter(graph), fullTextMapperV2, null);
