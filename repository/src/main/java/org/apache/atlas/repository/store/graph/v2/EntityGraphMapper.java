...
public class EntityGraphMapper {
        ...
        if (MapUtils.isNotEmpty(struct.getAttributes())) {
            ...
            if (op.equals(CREATE)) {
                for (AtlasAttribute attribute : structType.getAllAttributes().values()) {
                    ...
                    MetricRecorder createGetPropertyMetric = RequestContext.get().startMetricRecord("mapAttributes.create.getPropertyValues");
                    if (isArrayOfPrimitiveType || isArrayOfEnum) {
                    ...
                    RequestContext.get().endMetricRecord(createGetPropertyMetric);
                ...
                for (String attrName : struct.getAttributes().keySet()) {
                    ...
                    if (attribute != null) {
                        ...
                        MetricRecorder updateGetPropertyMetric = RequestContext.get().startMetricRecord("mapAttributes.update.getPropertyValues");
                        if (isArrayOfPrimitiveType || isArrayOfEnum) {
                            attrOldValue = vertex.getPropertyValues(attribute.getVertexPropertyName(),attribute.getClass());
                        } else {
                            attrOldValue = vertex.getProperty(attribute.getVertexPropertyName(),attribute.getClass());
                        }
                        RequestContext.get().endMetricRecord(updateGetPropertyMetric);
                        if (attrValue != null && !attrValue.equals(attrOldValue)) {
                            addValuesToAutoUpdateAttributesList(attribute, userAutoUpdateAttributes, timestampAutoUpdateAttributes);
                        }
            ...
            MetricRecorder updateMetadataAttributesMetric = RequestContext.get().startMetricRecord("mapAttributes.updateMetadataAttributes");
            ...
            RequestContext.get().endMetricRecord(updateMetadataAttributesMetric);
    ...
    private Object mapPrimitiveValue(AtlasVertex vertex, AtlasAttribute attribute, Object valueFromEntity, boolean isDeletedEntity) {
        ...
        MetricRecorder isIndexableStrAttrMetric = RequestContext.get().startMetricRecord("mapPrimitiveValue.isIndexableStrAttr");
        ...
        RequestContext.get().endMetricRecord(isIndexableStrAttrMetric);
        Object ret = valueFromEntity;

        MetricRecorder isIndexableStrAttrTrueMetric = RequestContext.get().startMetricRecord("mapPrimitiveValue.isIndexableStrAttrTrue");
        ...
        RequestContext.get().endMetricRecord(isIndexableStrAttrTrueMetric);


        MetricRecorder setEncodedPropertyMetric = RequestContext.get().startMetricRecord("mapPrimitiveValue.setEncodedProperty");
        AtlasGraphUtilsV2.setEncodedProperty(vertex, attribute.getVertexPropertyName(), ret);
        RequestContext.get().endMetricRecord(setEncodedPropertyMetric);
        ...
        if (uniqPropName != null) {
            ...
            if (isDeletedEntity) {
                ...
                MetricRecorder setEncodedPropertyAMetric = RequestContext.get().startMetricRecord("mapPrimitiveValue.setEncodedProperty2");
                AtlasGraphUtilsV2.setEncodedProperty(vertex, uniqPropName, ret);
                RequestContext.get().endMetricRecord(setEncodedPropertyAMetric);
            }
        }
